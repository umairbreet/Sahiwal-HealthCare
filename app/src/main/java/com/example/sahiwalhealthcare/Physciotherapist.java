...
public class Physciotherapist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_physciotherapist);
        ...
        fStore.collection("doctors").whereEqualTo("Specialize","Physiotherapist")
                .get()
