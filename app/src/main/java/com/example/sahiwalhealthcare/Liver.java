...
public class Liver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(Liver.this));
        ...
        model = new ArrayList< >();
        adapter = new DoctorAdapter(Liver.this,model);
        recyclerView.setAdapter(adapter);

        fStore.collection("doctors").whereEqualTo("Specialize","Liver")
                .get()
