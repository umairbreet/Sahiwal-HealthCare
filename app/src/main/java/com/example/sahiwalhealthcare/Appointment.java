...
public class Appointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.docRecycler);
        ...
        model = new ArrayList< >();
        adapter = new DoctorAdapter(Appointment.this,model);
        recyclerView.setAdapter(adapter);

        fStore.collection("doctors").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
