...
public class Immunologist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_immunologist);
        ...
        fStore.collection("doctors").whereEqualTo("Specialize","Immunologist")
                .get()
